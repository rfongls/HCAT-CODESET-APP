...
### 7. Codeset associated NBR

HL7 Segment and Field	Description	Code Set Name	HL7 2.3+ Data Type	Code Set NBR
				
PID Segment	Patient Demographic
...
NK1:39	VIP Indicator	CS_VIP_IND	IS	250
	NOTE: This list intentionally 			
	excludes NK1:19 and NK1:35, 
	which are not translated by 
...
ACC Accident Segment	Accident Information
...
OBR:24	Diagnostic Service Sec. ID	No Translation	ID	560
...
TXA:2.3.2	Diagnostic Service Sec. ID	No Translation	ID	560
		CS_DIAGNOSTIC_SERVICE_SECTION
